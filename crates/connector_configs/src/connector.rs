...
pub struct ConnectorConfig {
    ...
    pub amlconnector: Option<ConnectorTomlConfig>,
    ...
    pub nova: Option<ConnectorTomlConfig>,
    ...
    pub riskified2: Option<ConnectorTomlConfig>,
...
impl ConnectorConfig {
    ...
    pub fn get_connector_config(
        ...
        match connector {
            ...
            Connector::Riskified2 => Ok(connector_data.riskified2),
