...
pub use hyperswitch_connectors::connectors::{
    ...
    affirm::Affirm, airwallex, airwallex::Airwallex, amazonpay, amazonpay::Amazonpay, amlconnector,
    amlconnector::Amlconnector, archipel, archipel::Archipel, authipay, authipay::Authipay,
    ...
    nordea, nordea::Nordea, nova, nova::Nova, novalnet, novalnet::Novalnet, nuvei, nuvei::Nuvei,
    ...
    paytm::Paytm, payu, payu::Payu, phonepe, phonepe::Phonepe, placetopay, placetopay::Placetopay,
    ...
    redsys::Redsys, riskified, riskified::Riskified, riskified2, riskified2::Riskified2, santander,
